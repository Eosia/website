...
{
    /**
     * @Route("/admin/tag", name="mots_cles_index", methods={"GET"})
     */
    public function index(MotsClesRepository $motsClesRepository): Response
    {
        return $this->render('admin/mots_cles/index.html.twig', [
            'mots_cles' => $motsClesRepository->findAll(),
        ]);
    }

    /**
     * @Route("/admin/tag/new", name="mots_cles_new", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        ...
        return $this->render('admin/mots_cles/new.html.twig', [
            'mots_cle' => $motsCle,
    ...
    /**
     * @Route("/admin/tag/{id}", name="mots_cles_show", methods={"GET"})
     */
    public function show(MotsCles $motsCle): Response
    {
        return $this->render('admin/mots_cles/show.html.twig', [
            'mots_cle' => $motsCle,
        ]);
    }

    /**
     * @Route("/admin/tag/{id}/edit", name="mots_cles_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, MotsCles $motsCle): Response
    {
        ...
        return $this->render('admin/mots_cles/edit.html.twig', [
            'mots_cle' => $motsCle,
            'form' => $form->createView(),
        ]);
    }
    ...
    /**
     * @Route("/admin/tag/{id}", name="mots_cles_delete", methods={"DELETE"})
     */
